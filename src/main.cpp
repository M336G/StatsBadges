...
$on_mod(Loaded) {
    ...
    alpha::badgify::registerBadge(
        ...
        [](alpha::badgify::Badge const& badge) {
            ...
            alpha::badgify::showBadge(
                badge,
                CCSprite::createWithSpriteFrameName("GJ_bigMoon_noShadow_001.png")
            );
        }
    );
    alpha::badgify::registerBadge(
    ...
    alpha::badgify::registerBadge(
        ...
        [](alpha::badgify::Badge const& badge) {
            ...
            alpha::badgify::showBadge(
                badge,
                CCSprite::createWithSpriteFrameName("diffIcon_10_btn_001.png")
            );
        }
    );
    alpha::badgify::registerBadge(
        ...
        [](alpha::badgify::Badge const& badge) {
            ...
            alpha::badgify::showBadge(
                badge,
                CCSprite::createWithSpriteFrameName("diffIcon_06_btn_001.png")
            );
        }
    );
    alpha::badgify::registerBadge(
